...
def save_cookies_to_netscape_format(filepath):
    """Browser'dan alınan çerezleri Netscape formatında dosyaya kaydeder."""
    try:
        cookies = browser_cookie3.firefox(domain_name='youtube.com')
        with open(filepath, 'w') as f:
            # Netscape header
            f.write("# Netscape HTTP Cookie File\n")
            f.write("# This file is generated by browser_cookie3 for yt_dlp\n\n")
...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            cookie_file = save_cookies_to_netscape_format('youtube_cookies.txt')
            if not cookie_file:
